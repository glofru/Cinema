				...
				<div class="tab-content" id="myTabContent">
							...
							<div class="col-12">
								<div class="comments">
									<ul class="comments__list">
											<form action="{$path}/MagicBoulevardCinema/Admin/gestioneSale" method="POST">
					...
					<div class="tab-pane fade {if (isset($nSala) || isset($nPosti) || isset($nFile))}show active{/if}" id="tab-2" role="tabpanel" aria-labelledby="2-tab">
						<div class="row" style="align-content: center">
							<!-- reviews -->
							<form action="{$path}/MagicBoulevardCinema/Admin/gestioneSale" method="POST" style="margin: auto" class="form" style="align-content: center">
